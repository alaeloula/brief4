      ...
      <div class="col-xl-10">
        <div class="card rounded-3 text-black">
          <div class="row g-0">
              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form>
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="button" style="width: 300px; height: 40px;">Log
                      in</button>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2" style="background-color: rgb(26, 26, 29);">
